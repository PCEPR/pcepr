Ext.define('PCEPR.controller.Project', {
    extend: 'Ext.app.Controller',

    //define the stores
    stores: ['Countries'],
    //define the models
    models: ['project.Country'],
    //define the views
    views: ['project.CountryTree', 'project.EditMenu', 'project.AddMenu', 'project.CountryEdit'],
    refs: [{
    ...
    getAllCheckedNodes: function (button) {
        var selectedNodes = this.getMyCountryTree().getChecked();
    ...
    editCountry: function (item, e) {
        ...
        var countryWindow = this.getMyCountryWindow();
        ...
        countryWindow.down('form').getComponent('parentNodeId').setValue(this.application.currentRecord.parentNode.get('id'));
        //display the window       
        countryWindow.show();
    },
    ...
    addCountry: function (item, e) {
        ...
        var blankCountry = new MYTREE.model.Country();
    ...
    deleteCountry: function (item, e) {
        ...
        var node = this.application.currentRecord.parentNode.get('id');
        //data is the current node id
        var data = this.application.currentRecord.get('id');
    ...
    saveCountry: function (button) {
        ...
        if (form.getForm().isValid()) {
            ...
            var node = form.getComponent('parentNodeId').getValue();
    ...
    onSaveSuccess: function (response, opts) {
        ...
        var refreshNode = this.getCountriesStore().getNodeById(opts.params.parentNodeId);
